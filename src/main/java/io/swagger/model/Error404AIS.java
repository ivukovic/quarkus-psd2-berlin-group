...
import io.swagger.model.Error404AISAdditionalErrors;
import io.swagger.model.LinksAll;
import io.swagger.model.MessageCode404AIS;
...
public class Error404AIS   {
  ...
  private @Valid MessageCode404AIS code = null;
  private @Valid List<Error404AISAdditionalErrors> additionalErrors = new ArrayList<Error404AISAdditionalErrors>();
 ...
 @Size(max=500)
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(type, error404AIS.type) &&
        Objects.equals(title, error404AIS.title) &&
        Objects.equals(detail, error404AIS.detail) &&
        Objects.equals(code, error404AIS.code) &&
        Objects.equals(additionalErrors, error404AIS.additionalErrors) &&
        Objects.equals(_links, error404AIS._links);
  }
