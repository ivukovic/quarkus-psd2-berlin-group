...
import io.swagger.model.Error404PIISAdditionalErrors;
import io.swagger.model.LinksAll;
import io.swagger.model.MessageCode404PIIS;
...
public class Error404PIIS   {
  ...
  private @Valid MessageCode404PIIS code = null;
  private @Valid List<Error404PIISAdditionalErrors> additionalErrors = new ArrayList<Error404PIISAdditionalErrors>();
 ...
 @Size(max=500)
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(type, error404PIIS.type) &&
        Objects.equals(title, error404PIIS.title) &&
        Objects.equals(detail, error404PIIS.detail) &&
        Objects.equals(code, error404PIIS.code) &&
        Objects.equals(additionalErrors, error404PIIS.additionalErrors) &&
        Objects.equals(_links, error404PIIS._links);
  }
