...
public class V1Api {
    ...
    @Operation(summary = "Payment cancellation request", description = "This method initiates the cancellation of a payment.  Depending on the payment-service, the payment-product and the ASPSP's implementation,  this TPP call might be sufficient to cancel a payment.  If an authorisation of the payment cancellation is mandated by the ASPSP,  a corresponding hyperlink will be contained in the response message.  Cancels the addressed payment with resource identification paymentId if applicable to the payment-service, payment-product and received in product related timelines (e.g. before end of business day for scheduled payments of the last business day before the scheduled execution day).   The response to this DELETE command will tell the TPP whether the   * access method was rejected,   * access method was successful, or   * access method is generally applicable, but further authorisation processes are needed. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)" })
    @APIResponses(value = { 
 ...
 @Parameter(description = "Payment service:  Possible values are: * payments * bulk-payments * periodic-payments ") String paymentService
, @PathParam("payment-product")
...
, @PathParam("paymentId")
 ...
 @Parameter(description = "Resource identification of the generated payment initiation resource.") String paymentId
, @NotNull  @HeaderParam("X-Request-ID") 

 @Parameter(description = "ID of the request, unique to the call, as determined by the initiating party.") UUID xRequestID
,  @HeaderParam("Digest") 

 @Parameter(description = "Is contained if and only if the \&quot;Signature\&quot; element is contained in the header of the request.") String digest
,  @HeaderParam("Signature") 

 @Parameter(description = "A signature of the request by the TPP on application level. This might be mandated by ASPSP. ") String signature
,  @HeaderParam("TPP-Signature-Certificate") 
...
,  @HeaderParam("TPP-Redirect-Preferred") 
...
,  @HeaderParam("TPP-Nok-Redirect-URI") 
 ...
 @Parameter(description = "If this URI is contained, the TPP is asking to redirect the transaction flow to this address instead of the TPP-Redirect-URI in case of a negative result of the redirect SCA method. This might be ignored by the ASPSP. ") String tpPNokRedirectURI
...
,  @HeaderParam("PSU-IP-Address") 
 ...
 @Parameter(description = "The forwarded IP Address header field consists of the corresponding http request IP Address field between PSU and TPP. ") String psUIPAddress
,  @HeaderParam("PSU-IP-Port") 

 @Parameter(description = "The forwarded IP Port header field consists of the corresponding HTTP request IP Port field between PSU and TPP, if available. ") String psUIPPort
,  @HeaderParam("PSU-Accept") 

 @Parameter(description = "The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available. ") String psUAccept
,  @HeaderParam("PSU-Accept-Charset") 

 @Parameter(description = "The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available. ") String psUAcceptCharset
,  @HeaderParam("PSU-Accept-Encoding") 

 @Parameter(description = "The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available. ") String psUAcceptEncoding
,  @HeaderParam("PSU-Accept-Language") 

 @Parameter(description = "The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available. ") String psUAcceptLanguage
,  @HeaderParam("PSU-User-Agent") 

 @Parameter(description = "The forwarded Agent header field of the HTTP request between PSU and TPP, if available. ") String psUUserAgent
,  @HeaderParam("PSU-Http-Method") 

 @Parameter(description = "HTTP method used at the PSU ? TPP interface, if available. Valid values are: * GET * POST * PUT * PATCH * DELETE ") String psUHttpMethod
...
,  @HeaderParam("Authorization") 
 ...
 @Parameter(description = "This field  might be used in case where a consent was agreed between ASPSP and PSU through an OAuth2 based protocol,  facilitated by the TPP. ") String authorization
,  @HeaderParam("Digest") 
...
,  @HeaderParam("TPP-Signature-Certificate") 
 ...
 @Parameter(description = "ID of the request, unique to the call, as determined by the initiating party.") UUID xRequestID
, @NotNull  @HeaderParam("PSU-IP-Address") 

 @Parameter(description = "The forwarded IP Address header field consists of the corresponding http request IP Address field between PSU and TPP. If not available, the TPP shall use the IP Address used by the TPP when submitting this request. ") String psUIPAddress
,@Valid Consents body,  @HeaderParam("Digest") 
...
,  @HeaderParam("PSU-ID-Type") 
 ...
 @Parameter(description = "Type of the PSU-ID, needed in scenarios where PSUs have several PSU-IDs as access possibility.  In this case, the mean and use are then defined in the ASPSP’s documentation. ") String psUIDType
,  @HeaderParam("PSU-Corporate-ID") 

 @Parameter(description = "Might be mandated in the ASPSP&#x27;s documentation. Only used in a corporate context. ") String psUCorporateID
,  @HeaderParam("PSU-Corporate-ID-Type") 

 @Parameter(description = "Might be mandated in the ASPSP&#x27;s documentation. Only used in a corporate context. ") String psUCorporateIDType
,  @HeaderParam("TPP-Redirect-Preferred") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @Operation(summary = "Create a signing basket resource", description = "Create a signing basket resource for authorising several transactions with one SCA method.  The resource identifications of these transactions are contained in the payload of this access method ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Signing Baskets (SBS)" })
    @ApiResponses(value = { 
...
, @NotNull  @HeaderParam("PSU-IP-Address") 
 ...
 @Parameter(description = "The forwarded IP Address header field consists of the corresponding http request IP Address field between PSU and TPP. If not available, the TPP shall use the IP Address used by the TPP when submitting this request. ") String psUIPAddress
,@Valid SigningBasket body,  @HeaderParam("Digest") 
...
,  @HeaderParam("PSU-Corporate-ID-Type") 
 ...
 @Parameter(description = "Might be mandated in the ASPSP&#x27;s documentation. Only used in a corporate context. ") String psUCorporateIDType
,  @HeaderParam("Consent-ID") 

 @Parameter(description = "This data element may be contained, if the payment initiation transaction is part of a session, i.e. combined AIS/PIS service. This then contains the consentId of the related AIS consent, which was performed prior to this payment initiation. ") String consentID
,  @HeaderParam("TPP-Redirect-Preferred") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "ID of the corresponding consent object as returned by an account information consent request. ") String consentId
, @NotNull  @HeaderParam("X-Request-ID") 
...
,  @HeaderParam("PSU-IP-Address") 
 ...
 @Parameter(description = "The forwarded IP Address header field consists of the corresponding HTTP request  IP Address field between PSU and TPP.  It shall be contained if and only if this request was actively initiated by the PSU. ") String psUIPAddress
,  @HeaderParam("PSU-IP-Port") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @Operation(summary = "Delete the signing basket", description = "Delete the signing basket structure as long as no (partial) authorisation has yet been applied.  The undlerying transactions are not affected by this deletion.  Remark: The signing basket as such is not deletable after a first (partial) authorisation has been applied.  Nevertheless, single transactions might be cancelled on an individual basis on the XS2A interface. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Signing Baskets (SBS)", "Common Services" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "204", description = "No Content"),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error400NGSBS.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error401NGSBS.class))),
 ...
 @Parameter(description = "This identification of the corresponding signing basket object. ") String basketId
, @NotNull  @HeaderParam("X-Request-ID") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "ID of the request, unique to the call, as determined by the initiating party.") UUID xRequestID
, @NotNull  @HeaderParam("Consent-ID") 

 @Parameter(description = "This then contains the consentId of the related AIS consent, which was performed prior to this payment initiation. ") String consentID
,  @QueryParam("withBalance") 

 @Parameter(description = "If contained, this function reads the list of accessible payment accounts including the booking balance,  if granted by the PSU in the related consent and available by the ASPSP.  This parameter might be ignored by the ASPSP.  ")  Boolean withBalance
,  @HeaderParam("Digest") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/card-accounts/{account-id}/balances")
    @Produces({ "application/json", "application/problem+json" })
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/card-accounts/{account-id}/transactions")
    @Produces({ "application/json", "application/problem+json" })
 ...
 @Parameter(description = "This identification is denoting the addressed (card) account.  The account-id is retrieved by using a \&quot;Read Account List\&quot; or \&quot;Read Card Account list\&quot; call.  The account-id is the \&quot;resourceId\&quot; attribute of the account structure.  Its value is constant at least throughout the lifecycle of a given consent. ") String accountId
, @NotNull  @QueryParam("bookingStatus") 

 @Parameter(description = "Permitted codes are    * \&quot;information\&quot;,   * \&quot;booked\&quot;,   * \&quot;pending\&quot;, and    * \&quot;both\&quot; \&quot;booked\&quot; shall be supported by the ASPSP. To support the \&quot;pending\&quot; and \&quot;both\&quot; feature is optional for the ASPSP,  Error code if not supported in the online banking frontend ")  String bookingStatus
, @NotNull  @HeaderParam("X-Request-ID") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "ID of the corresponding consent object as returned by an account information consent request. ") String consentId
, @PathParam("authorisationId")

 @Parameter(description = "Resource identification of the related SCA.") String authorisationId
, @NotNull  @HeaderParam("X-Request-ID") 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/{payment-service}/{payment-product}/{paymentId}/cancellation-authorisations/{authorisationId}")
    @Produces({ "application/json", "application/problem+json" })
    @Operation(summary = "Read the SCA status of the payment cancellation's authorisation", description = "This method returns the SCA status of a payment initiation's authorisation sub-resource. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)", "Common Services" })
    @APIResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ScaStatusResponse.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error400NGPIS.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error401NGPIS.class))),
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @Operation(summary = "Get payment information", description = "Returns the content of a payment object", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)" })
    @ApiResponses(value = { 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/{payment-service}/{payment-product}/{paymentId}/authorisations")
    @Produces({ "application/json", "application/problem+json" })
    @Operation(summary = "Get payment initiation authorisation sub-resources request", description = "Read a list of all authorisation subresources IDs which have been created.  This function returns an array of hyperlinks to all generated authorisation sub-resources. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)", "Common Services" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = Authorisations.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error400NGPIS.class))),
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/{payment-service}/{payment-product}/{paymentId}/cancellation-authorisations")
    @Produces({ "application/json", "application/problem+json" })
    @Operation(summary = "Will deliver an array of resource identifications to all generated cancellation authorisation sub-resources", description = "Retrieve a list of all created cancellation authorisation sub-resources. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = Authorisations.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error400NGPIS.class))),
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @Produces({ "application/json", "application/problem+json" })
    @Operation(summary = "Read the SCA status of the payment authorisation", description = "This method returns the SCA status of a payment initiation's authorisation sub-resource. ", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)", "Common Services" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ScaStatusResponse.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error400NGPIS.class))),
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @Operation(summary = "Payment initiation status request", description = "Check the transaction status of a payment initiation.", security = {
        @SecurityRequirement(name = "BearerAuthOAuth")    }, tags={ "Payment Initiation Service (PIS)" })
    @ApiResponses(value = { 
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/signing-baskets/{basketId}/authorisations")
    @Produces({ "application/json", "application/problem+json" })
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/signing-baskets/{basketId}/authorisations/{authorisationId}")
    @Produces({ "application/json", "application/problem+json" })
...
, @Pattern(regexp="GEO:-?[0-9]{1,2}\\.[0-9]{6};-?[0-9]{1,3}\\.[0-9]{6}")  @HeaderParam("PSU-Geo-Location") 
 ...
 @Parameter(description = "The forwarded Geo Location of the corresponding http request between PSU and TPP if available. ") String psUGeoLocation
    ...
    @GET
    @Path("/accounts/{account-id}/transactions/{transactionId}")
    @Produces({ "application/json", "application/problem+json" })
...
, @PathParam("transactionId")
 ...
 @Parameter(description = "This identification is given by the attribute transactionId of the corresponding entry of a transaction list. ") String transactionId
, @NotNull  @HeaderParam("X-Request-ID") 
...
, @PathParam("consentId")
 ...
 @Parameter(description = "ID of the corresponding consent object as returned by an account information consent request. ") String consentId
,@Valid Body4 body,  @HeaderParam("Digest") 
...
, @PathParam("paymentId")
 ...
 @Parameter(description = "Resource identification of the generated payment initiation resource.") String paymentId
,@Valid Body body,  @HeaderParam("PSU-ID") 
...
, @PathParam("paymentId")
 ...
 @Parameter(description = "Resource identification of the generated payment initiation resource.") String paymentId
,@Valid Body2 body,  @HeaderParam("Digest") 
...
, @PathParam("basketId")
 ...
 @Parameter(description = "This identification of the corresponding signing basket object. ") String basketId
,@Valid Body6 body,  @HeaderParam("Digest") 
...
, @PathParam("authorisationId")
 ...
 @Parameter(description = "Resource identification of the related SCA.") String authorisationId
,@Valid Body5 body,  @HeaderParam("Digest") 
...
, @PathParam("authorisationId")
 ...
 @Parameter(description = "Resource identification of the related SCA.") String authorisationId
,@Valid Body3 body,  @HeaderParam("Digest") 
...
, @PathParam("authorisationId")
 ...
 @Parameter(description = "Resource identification of the related SCA.") String authorisationId
,@Valid Body1 body,  @HeaderParam("Digest") 
...
, @PathParam("authorisationId")
 ...
 @Parameter(description = "Resource identification of the related SCA.") String authorisationId
,@Valid Body7 body,  @HeaderParam("Digest") 
